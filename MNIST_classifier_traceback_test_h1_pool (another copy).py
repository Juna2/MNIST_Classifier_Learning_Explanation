...
with tf.Session(graph=g2) as sess:
    ...
    if return_proba:
        ...
        image, Conv1Kernel, conv_1_result, result_of_h1_pool, Conv2Kernel, conv_2_result, fc_3_w, h2_pool, fc_3_b, fc_4_w, fc_3_result, fc_4_b, fc_4_result, preds = \
        sess.run(['tf_x:0', 'conv_1/_weights:0', 'conv_1/activation:0','h1_pool:0', 'conv_2/_weights:0', 'conv_2/activation:0', 'fc_3/_weights:0', 'h2_pool:0', 'fc_3/_biases:0', 'fc_4/_weights:0', 'fc_3/activation:0', 'fc_4/_biases:0', 'fc_4/net_pre-activation:0','labels:0'], feed_dict=feed)
    ...
    #     SortedMulMember_plus = SortedMulMember - SortedMulMember.min()
    #     sum_1 = np.sum(SortedMulMember_plus)
    #     for index, i in enumerate(list(SortedMulMember_plus)):
    #         sum_2 += i
    ...
    PixelsToBeRedFc3, Fc3RedValue = activated_nodes(fc_3_result, np.array([fc_4_w[:,7]]), 1)
    print_('fc_3_result.shape')
    print_('fc_4_w.shape')
    print_('fc_4_b.shape')
    print_('PixelsToBeRedFc3')
    print_('fc_3_result[0,PixelsToBeRedFc3]')
    print_('fc_4_w[:,7][PixelsToBeRedFc3]')
    print_('fc_4_w[:,7]')
    # print_('fc_3_result[0,PixelsToBeRedFc3]*fc_4_w[:,7][PixelsToBeRedFc3]+fc_4_b[7]')
    ...
    # # '''===================================Show Red Pixels===================================='''
    # # '''input : conv_2_result , RowNumber, ColNumber
    # # PixelsToBeRedConv2(All red pixel's coord and channel | column, row, channel, RedValue)'''
    ...
    #                 activated_nodes(Pixel1x800ValuefromH1pool, Kernel1x800Value, StartPointOfCutting5x5[3])
    ...
    # '''=========================Collect all same pixels' Red values========================='''
    # '''input : PixelsToBeRedH1pool<(column, row, channel, redvalue)>, result_of_h1_pool<1x12x12x32>'''
    # np.set_printoptions(threshold=np.inf)
    ...
    # # print_('PixelsToBeRedH1pool.shape')
    # # '''===================================Show Red Pixels===================================='''
    # # '''input : result_of_h1_pool , RowNumber, ColNumber, **threshold**<if i <= 0.1:>
    # # PixelsToBeRedH1pool(All red pixel's coord and channel | column, row, channel, RedValue)'''
    ...
    # '''input : PixelsToBeRedH1pool, conv_1_result, '''
    ...
    # # '''===================================Show Red Pixels===================================='''
    # # '''input : conv_1_result , RowNumber, ColNumber, **threshold**<if i <= 0.1:>
    # # PixelsToBeRedConv1(All red pixel's coord and channel | column, row, channel, RedValue)'''
    ...
    # '''===================================image <- conv1===================================='''
    # '''input : image, Conv1Kernel(5x5x?x?), PixelsToBeRedConv1(column, row, channel)'''
    ...
    #                 activated_nodes(Pixel1x25ValuefromImage, Kernel1x25Value, StartPointOfCutting5x5[3])
    ...
    # np.set_printoptions(threshold=np.inf)
    # print_('PixelsToBeRedImage.shape') # (1, 117, 3)
    # np.set_printoptions(threshold=1000)


    # # '''=========================Collect all same pixels' Red values========================='''
    # # '''input : PixelsToBeRedImage<(column, row, redvalue),(1,117,3)>, image<1x12x12x32>'''
    # # np.set_printoptions(threshold=np.inf)
    ...
    # print_('PixelsToBeRedImage')
    # '''===================================Show Red Pixels===================================='''
    # '''input : image , RowNumber, ColNumber, **threshold**<if i <= 0.1:>
    # PixelsToBeRedImage(105, 3)(All red pixel's coord and channel | column, row, channel, RedValue)'''
    # Image2D = np.resize(image, (28,28))
    ...
    # print_('PixelsToBeRedImage_Nor')
    # print_('PixelsToBeRedImage_Nor.shape')
    # print_('Image2D')
    # np.set_printoptions(threshold=1000)
